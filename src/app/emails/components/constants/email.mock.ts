...
export const EMAILS_MOCK_DATA: Email[] = [
  ...
  {id: uuidv4(), subject: 'Weekly Projects', date: '31/1/23', name: 'Noam', description: 'Your shipment has arrived at the supplier and will reach you within a few days'},
  {id: uuidv4(), subject: 'Verify your email address with TikTok', date: '30/1/23', name: 'Olivia Deko', 
  description: 'You need to confirm your account by entering your email. Please click on the link and enter your email'},
  {id: uuidv4(), subject: 'Verify your email address with TikTok', date: '25/1/23', name: 'Frank Mosh', description: ''},
  {id: uuidv4(), subject: 'Neon', date: '23/1/23', name: 'Neil Wes', description: ''},
  ];
