...
export class UsersService {
  ...
  private user: Users[] = [
    ...
    new Users('Ron', 'Biton', 7, 'Uk', 'Edinburgh', 28, ''),
    new Users('Ben', 'Hen', 8, 'Uk', 'Edinburgh', 28, ''),
    new Users('David', 'Barbur', 9, 'Uk', 'Edinburgh', 28, ''),
    new Users('Leo', 'Chohen', 10, 'Uk', 'Edinburgh', 28, ''),
    new Users('Mar', 'Levin', 11, 'Uk', 'Edinburgh', 28, ''),
    new Users('Dan', 'Fani', 12, 'Uk', 'Edinburgh', 28, ''),
    new Users('Avi', 'Sharil', 13, 'Uk', 'Edinburgh', 28, ''),
    new Users('Bar', 'Luf', 14, 'Uk', 'Edinburgh', 28, ''),
    new Users('Chen', 'Bur', 15, 'Uk', 'Edinburgh', 28, ''),
    new Users('Hadar', 'Rovelli', 16, 'Uk', 'Edinburgh', 28, ''),
    new Users('Ian', 'Rovelli', 17, 'Uk', 'Edinburgh', 28, ''),
    new Users('Lili', 'Rovelli', 18, 'Uk', 'Edinburgh', 28, ''),
    new Users('Guy', 'Rovelli', 19, 'Uk', 'Edinburgh', 28, ''),
    new Users('Efrat', 'Rovelli', 20, 'Uk', 'Edinburgh', 28, ''),
